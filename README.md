This is a simple registration form which is built using React. In this we enter some basic details like name, email, mobile number and city to get registered. 
